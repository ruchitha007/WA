...
- Various ways of encoding information in URL
  - In fragment part of the URL: [HashRouter](https://reacttraining.com/react-router/web/api/HashRouter)
  - Use HTML5 URL handler: [BrowserRouter](https://reacttraining.com/react-router/web/api/BrowserRouter)
- Import as a module:
